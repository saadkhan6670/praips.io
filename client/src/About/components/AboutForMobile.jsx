...
@observer class AboutComponent extends Component {
    ...
    editHandle = () =>  {
        document.getElementById('aboutDataMob').style.display = "none"
        document.getElementById('aboutFormMob').style.display = "block"
    }

    handleCancel() {
        document.getElementById('aboutDataMob').style.display = "block"
        document.getElementById('aboutFormMob').style.display = "none"
    }
        ...
        return (
            <div>
                ...
                <div className={this.props.store.redirect ? "AdminRight-wrapper" : "right-wrapper"} id="intro">
                    ...
                    <div className={this.state.cssToggle ? "container-fluid AdminAboutContainer" : "container-fluid"} id="aboutDataMob">
                        <div >
                            <div className="row">
                    ...
                    <div className="container-fluid" id="aboutFormMob" >
